                ...
                <div className="flex-1 overflow-y-auto p-6">
                    ...
                    {cart.map((item, index) => (
                        <div key={item._id || index} className="flex gap-4 mb-6 pb-6 border-b border-zinc-800 last:border-0">
                            <div className="w-20 h-20 bg-zinc-800 rounded-lg flex-shrink-0 flex items-center justify-center">
                            ...
                            <div className="flex-grow">
                                <h3 className="text-white font-bold text-sm">Product ID: {item.item}</h3>
                                <p className="text-gray-400 text-xs mt-1">
                                    Size: {item.size} | Qty: {item.quantity || 1}
                                </p>
                                <p className="text-gray-500 text-xs">SKU: {item.skuColorCode}</p>
