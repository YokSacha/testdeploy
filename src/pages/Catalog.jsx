          ...
          <div className="overflow-hidden">
            <div className="flex gap-4 animate-marquee w-max">
              {[...PARTNERS, ...PARTNERS].map((item, index) => (
                <div key={`${item}-${index}`} className="flex-shrink-0 w-[120px] h-[64px] border border-[#1e1e20] rounded-xl bg-[#0f0f10] hover:border-[#C3FF51]/30 transition-colors duration-200 cursor-pointer flex items-center justify-center">
